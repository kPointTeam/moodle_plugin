...
/**
 * The mod_kpoint course module viewed event.
 *
 * @package    mod_kpoint
 */
...
/**
 * The mod_kpoint course module viewed event class.
 *
 * @package    mod_kpoint
 */
class course_module_viewed extends \core\event\course_module_viewed
{
    ...
    */
    public function get_description()
    {
        ...
        return "The user '{$user->username}' (user id->{$this->userid}) has successfully Completed watching the '{$this->objecttable}' video named '{$kpoint->name}'(video id->{$this->objectid}) of "
